  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        ...
        enumBloodTypeABO::
        enumBloodTypeABO (value v)
        : ::xml_schema::string (_xsd_enumBloodTypeABO_literals_[v])
        {
        }

        enumBloodTypeABO::
        enumBloodTypeABO (const char* v)
        : ::xml_schema::string (v)
        {
        }

        enumBloodTypeABO::
        enumBloodTypeABO (const ::std::string& v)
        : ::xml_schema::string (v)
        {
        }

        enumBloodTypeABO::
        enumBloodTypeABO (const ::xml_schema::string& v)
        : ::xml_schema::string (v)
        {
        }

        enumBloodTypeABO::
        enumBloodTypeABO (const enumBloodTypeABO& v,
                          ::xml_schema::flags f,
        ...
        enumBloodTypeABO& enumBloodTypeABO::
        operator= (value v)
        {
        ...
        const SubstanceData::Antigen_optional& SubstanceData::
        Antigen () const
        {
          return this->Antigen_;
        }

        SubstanceData::Antigen_optional& SubstanceData::
        Antigen ()
        {
          return this->Antigen_;
        }
        ...
        void SubstanceData::
        Antigen (const Antigen_type& x)
        {
          this->Antigen_.set (x);
        }

        void SubstanceData::
        Antigen (const Antigen_optional& x)
        {
          this->Antigen_ = x;
        }

        void SubstanceData::
        Antigen (::std::unique_ptr< Antigen_type > x)
        {
          this->Antigen_.set (std::move (x));
        }
  ...
  namespace tatrc
  {
    namespace physiology
    {
      namespace datamodel
      {
        ...
        enumBloodTypeABO::
        enumBloodTypeABO (const ::xercesc::DOMElement& e,
                          ::xml_schema::flags f,
                          ::xml_schema::container* c)
        : ::xml_schema::string (e, f, c)
        {
          _xsd_enumBloodTypeABO_convert ();
        }

        enumBloodTypeABO::
        enumBloodTypeABO (const ::xercesc::DOMAttr& a,
                          ::xml_schema::flags f,
                          ::xml_schema::container* c)
        ...
        enumBloodTypeABO::
        enumBloodTypeABO (const ::std::string& s,
        ...
        {
          return new class enumBloodTypeABO (*this, f, c);
        }

        enumBloodTypeABO::value enumBloodTypeABO::
        _xsd_enumBloodTypeABO_convert () const
        {
          ::xsd::cxx::tree::enum_comparator< char > c (_xsd_enumBloodTypeABO_literals_);
          const value* i (::std::lower_bound (
                            _xsd_enumBloodTypeABO_indexes_,
                            _xsd_enumBloodTypeABO_indexes_ + 4,
                            *this,
                            c));

          if (i == _xsd_enumBloodTypeABO_indexes_ + 4 || _xsd_enumBloodTypeABO_literals_[*i] != *this)
          {
        ...
        const char* const enumBloodTypeABO::
        _xsd_enumBloodTypeABO_literals_[4] =
        {
          "A",
          "B",
          "AB",
        ...
        const enumBloodTypeABO::value enumBloodTypeABO::
        _xsd_enumBloodTypeABO_indexes_[4] =
        {
          ::mil::tatrc::physiology::datamodel::enumBloodTypeABO::A,
          ::mil::tatrc::physiology::datamodel::enumBloodTypeABO::AB,
          ::mil::tatrc::physiology::datamodel::enumBloodTypeABO::B,
          ::mil::tatrc::physiology::datamodel::enumBloodTypeABO::O
        };

        static
        const ::xsd::cxx::tree::type_factory_initializer< 0, char, enumBloodTypeABO >
        _xsd_enumBloodTypeABO_type_factory_init (
          "enumBloodTypeABO",
            ...
            //
            {
              ::std::unique_ptr< ::xsd::cxx::tree::type > tmp (
                ::xsd::cxx::tree::type_factory_map_instance< 0, char > ().create (
                  "Antigen",
                  "uri:/mil/tatrc/physiology/datamodel",
                  &::xsd::cxx::tree::factory_impl< Antigen_type >,
                  false, true, i, n, f, this));
              ...
              if (tmp.get () != 0)
              {
                if (!this->Antigen_)
                {
                  ::std::unique_ptr< Antigen_type > r (
                    dynamic_cast< Antigen_type* > (tmp.get ()));
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        ::std::ostream&
        operator<< (::std::ostream& o, enumBloodTypeABO::value i)
        {
          return o << enumBloodTypeABO::_xsd_enumBloodTypeABO_literals_[i];
        }

        ::std::ostream&
        operator<< (::std::ostream& o, const enumBloodTypeABO& i)
        {
          return o << static_cast< const ::xml_schema::string& > (i);
        }

        static
        const ::xsd::cxx::tree::std_ostream_initializer< 0, char, enumBloodTypeABO >
        _xsd_enumBloodTypeABO_std_ostream_init;
...
namespace mil
{
  namespace tatrc
  {
    namespace physiology
    {
      ...
      {
        void
        operator<< (::xercesc::DOMElement& e, const enumBloodTypeABO& i)
        {
          e << static_cast< const ::xml_schema::string& > (i);
        }

        void
        operator<< (::xercesc::DOMAttr& a, const enumBloodTypeABO& i)
        {
        ...
        operator<< (::xml_schema::list_stream& l,
                    const enumBloodTypeABO& i)
        {
          l << static_cast< const ::xml_schema::string& > (i);
        }

        static
        const ::xsd::cxx::tree::type_serializer_initializer< 0, char, enumBloodTypeABO >
        _xsd_enumBloodTypeABO_type_serializer_init (
          "enumBloodTypeABO",
          "uri:/mil/tatrc/physiology/datamodel");
        ...
        operator<< (::xercesc::DOMElement& e, const SubstanceData& i)
        {
          ...
          //
          {
            ...
            if (i.Antigen ())
            {
              const SubstanceData::Antigen_type& x (*i.Antigen ());
              if (typeid (SubstanceData::Antigen_type) == typeid (x))
              {
                ::xercesc::DOMElement& s (
                  ::xsd::cxx::xml::dom::create_element (
                    "Antigen",
